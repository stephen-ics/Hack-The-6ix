    ...
    <div className='flex justify-center'>
        ...
        <div className='flex items-start bg-gray-100/[0.8] h-full rounded-xl shadow-xl p-10 w-full pt-20'> 
            <div className='flex flex-col w-full h-full ml-20'>
              <div className='bg-purple-100 w-1/2 shadow-xl rounded-2xl text-4xl p-10'>{stockData.title}</div>
              <div className='bg-violet-300  w-1/2 shadow-xl rounded-2xl pb-60 p-10 text-4xl mt-10'>L2</div>
            </div>
